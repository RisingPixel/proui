...

{
	...
	C3.Behaviors.aekiro_checkbox = class aekiro_checkboxBehavior extends globalThis.ISDKBehaviorBase
	{
		constructor()
		{
			super();
		...
		async _OnInputDown(source, b, c) {
			...
			for (const inst of insts) {
				const beh = globalThis.Aekiro.getInstanceData(inst).aekiro_checkbox;
				if(!beh) continue;
				const wi = inst,
				layer = wi.GetLayer(),
