	...
	const BEHAVIOR_CLASS = SDK.Behaviors.aekiro_button = class aekiro_button extends SDK.IBehaviorBase
	{
		constructor()
		{
			...
			this._info.SetProperties([
				...
				new SDK.PluginProperty("text", "normal-frame", ""),
				new SDK.PluginProperty("text", "hover-frame", ""),
				new SDK.PluginProperty("text", "clicked-frame", ""),
				new SDK.PluginProperty("text", "disabled-frame", ""),
